...
// Import a highlight.js CSS theme (you can choose another theme if you prefer)
...
const setupMarked = () => {
  ...
  renderer.code = (token) => {
    // token is an object with properties: type, raw, lang, text, etc.
    console.log('Code block token:', token);
  ...
  renderer.codespan = (code) => {
    console.log('Inline code content:', code, typeof code);
...
export default async function BlogPost({ params }) {
  ...
  // Get related posts (this is a placeholder - implement actual related posts logic)
